...
if 100>=user_grade >= 90:  # Check if the grade is 90 or above  
    category_name = "A"  
elif 90> user_grade >= 80:  # Check if the grade is 80 or above  
    category_name = "B"  
elif 80> user_grade >= 70:  # Check if the grade is 70 or above  
    category_name = "C"  
elif 70> user_grade >= 60:  # Check if the grade is 60 or above  
    category_name = "D"  
